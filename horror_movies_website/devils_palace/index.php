...
<div
    ...
    style="background-position: 50%; background-image: url('assets/img/girl-suspiria.png'); height: 515px;">

    <!-- Votre contenu va ici -->
    <div class="px-6 text-left text-white md:px-12">
        <h1 class="mt-20 mb-4 pb-20 text-5xl font-bold">UNE NOUVELLE FAÇON D'AVOIR PEUR</h1>
        <h3 class="mb-2 pb-7 text-3xl font-bold">Faites l'essai de 7 jours gratuits</h3>
        <div class="mb-0">
            <div class="relative flex w-full flex-wrap items-stretch">
                <div class="relative flex text-white items-stretch">
                    <input
                    type="search"
                    class="relative m-1 -mr-0.5 block w-80 min-w-0 flex-auto px-4 py-4 font-normal dark:text-black"
                    placeholder="Adresse électronique"
                    aria-label="Search"
                    aria-describedby="button-addon3" />
                    <!--Search button-->
                    <button
                    class="relative z-2 border-2 px-4 py-4 text-m font-medium border-black uppercase transition text-white bg-gray-950 hover-bg-opacity-5 focus:outline-none focus:ring-0 "
                    type="button"
                    id="button-addon3"
                    data-te-ripple-init>
                    J'EN PROFITE
        ...
        <p class="mt-6 mb-5 pb-20 text-xs font-semibold">En cliquant le bouton « J'en profite », vous indiquez avoir lu et accepté les <u>Termes de Services</u> et la <u>Politique de confidentialité</u>.</p>
    </div>
</div>
</div>
...
<div id="indicators-carousel" class="mt-4 relative w-full" data-carousel="static">
    ...
    <button
        class="relative z-2 px-2 py-2 text-m top-64 left-44 mt-12 ml-8 uppercase transition text-gray-950 bg-white hover:bg-red-600 rounded-full focus:outline-none focus:ring-0 flex items-center"
        type="button"
        id="button-addon3"
        data-te-ripple-init>
    ...
    <button
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            ...
            <div class="flex">
    <button
        class="relative z-2 px-2 py-2 text-m top-72 left-44 mt-8 ml-32 uppercase transition text-gray-950 bg-white hover:bg-red-600 rounded-full focus:outline-none focus:ring-0 flex items-center"
        type="button"
        id="button-addon3"
        data-te-ripple-init>
        <img src="assets/img/circle-plus-solid.svg" class="w-6 h-6" alt="SVG Image">
        ...
        <!-- Item 4 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="assets/img/freddy.png" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">

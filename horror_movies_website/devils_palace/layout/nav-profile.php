...
<div class="block transition duration-150 ease-in-out hover:text-neutral-700 font-semibold focus:text-neutral-700 disabled:text-black/30 dark:hover:text-neutral-900 dark:focus:text-neutral mt-2 ml-0 mr-2" data-te-nav-link-ref data-te-ripple-init data-te-ripple-color="light">
    CATALOGUE
    <svg class="w-[17px] h-[20px] ml-8 text-gray-800 dark:text-black cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8" id="dropdown-toggle" >
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 5.326 5.7a.909.909 0 0 0 1.348 0L13 1"/>
    </svg>
</div>
<ul class="absolute z-[1000] float-left pt-2 mt-1 pr-3 pl-3 hidden min-w-max list-none overflow-hidden rounded-lg bg-inherit bg-clip-padding text-left text-base text-slate-950 border shadow-lg" id="dropdown-menu" style="top: 70px;">
    <li>
    ...
    <li class="mb-4 lg:mb-0 mr-2 ml-4 lg:pr-2" data-te-nav-item-ref>
        <a
    ...
    <li class="mb-4 lg:mb-0 mr-2 ml-2 lg:pr-2" data-te-nav-item-ref>
        <a
        class="block transition duration-150 ease-in-out font-semibold disabled:text-black/30 dark:hover:text-neutral-950 lg:p-2 [&.active]:text-black/90"
        href="#!"
        data-te-nav-link-ref
    ...
    <li class="mb-2 mr-2 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
        <a
    ...
    <li class="relative">
    <img src="<?php echo $_SESSION['userInfos']['profile_photo']; ?>" alt="Photo de profil" class="profile-photo">
    <svg class="w-[17px] h-[20px] ml-11 text-gray-800 dark:text-black cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8" id="dropdown-toggle-Profile">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 5.326 5.7a.909.909 0 0 0 1.348 0L13 1"/>
    </svg>
    <ul class="absolute z-[1000] ml-5 pl-2 pr-2 pt-1 pb-1 min-w-max list-none overflow-hidden rounded-lg bg-orange-300 bg-clip-padding text-left text-base text-slate-950 border shadow-lg hidden" id="dropdown-menu-Profile" style="top: 65px;">
